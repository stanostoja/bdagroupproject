...
output:
  html_document:
    css: ../bdagroupproject/0_lib/default.css
    theme: paper
    toc: yes
    toc_float:
      collapsed: no
  ...
  pdf_document:
    includes:
      in_header: ../bdagroupproject/0_lib/default.sty
...
datafile_name = "../bdagroupproject/Data/loancopy_2.csv"
...
-  Segment 1: low loan amount, non-verified income sources and low annual income  
-  Segment 2: average population representative  
-  Segment 3: medium-to-high loan amount, verified income sources and medium-to-high annual income  
-  Segment 4: history of derogatory public records  
-  Segment 5: high loan amount, verified income sources and high annual income
