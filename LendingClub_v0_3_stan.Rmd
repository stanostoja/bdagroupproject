...
datafile_name = "Data/loancopy_1.csv"
...
We are interested in understanding the purchase drivers, hence our **dependent** variable is "loan_status" column 17 of the Lending Club Loan data (`r colnames(ProjectData)[16]`). This variable takes value 1 if the loan was fully paid and 0 in the opposite case.
...
dependent_variable= 16

# Please ENTER the attributes to use as independent variables 
# Please use numbers, not column names! e.g. c(1:5, 7, 8) uses columns 1,2,3,4,5,7,8
independent_variables= c(3:15,17:23) # use 54-80 for boats
...
avg_estimation_data_success = round(mean(estimation_data[,16]),2)
avg_validation_data_success = round(mean(validation_data[,16]),2)
avg_test_data_success = round(mean(test_data[,16]),2)
```
